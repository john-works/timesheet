...
class MultiUpdateTableDTOTest extends TestCase
{
    ...
    public function testSetterAndGetter(): void
    {
        ...
        self::assertInstanceOf(MultiUpdateTableDTO::class, $sut->setEntities([$tag, $timesheet, $activity, $department, $project]));
        self::assertEquals([$tag, $timesheet, $activity, $department, $project], $sut->getEntities());
    }
}
