...
abstract class AbstractVoterTestCase extends TestCase
{
    ...
    protected function getRolePermissionManager(array $permissions = [], bool $overwrite = false): RolePermissionManager
    {
        if (!$overwrite) {
            ...
            $departments = ['view_department', 'create_department', 'edit_department', 'budget_department', 'time_department', 'delete_department', 'permissions_department', 'comments_department', 'details_department'];
            $departmentsTeam = ['view_teamlead_department', 'edit_teamlead_department', 'budget_teamlead_department', 'time_teamlead_department', 'comments_teamlead_department', 'details_teamlead_department'];
            ...
            $roleUser = ['view_team_member', 'edit_team_activity', 'edit_team_project', 'edit_team_department'];
            ...
            $permissions = [
                ...
                'ROLE_TEAMLEAD' => array_merge($invoice, $timesheet, $timesheetOthers, $profile, $roleTeamlead, $activitiesTeam, $projectsTeam, $departmentsTeam),
                'ROLE_ADMIN' => array_merge($activities, $projects, $departments, $invoice, $invoiceTemplate, $timesheet, $timesheetOthers, $profile, $rate, $rateOther, $roleAdmin, $teams),
                'ROLE_SUPER_ADMIN' => array_merge($activities, $projects, $departments, $invoice, $invoiceTemplate, $timesheet, $timesheetOthers, $profile, $profileOther, $user, $rate, $rateOther, $roleSuperAdmin, $teams),
            ];
        }
