...
class ColumnConverterTest extends TestCase
{
    ...
    public function testWithMetaFields(): void
    {
        ...
        $dispatcher->method('dispatch')->willReturnCallback(function (AbstractMetaDisplayEvent|UserPreferenceDisplayEvent $event) {
            if ($event instanceof DepartmentMetaDisplayEvent) {
                $event->addField((new DepartmentMeta())->setName('foo_meta')->setIsVisible(true));
                $event->addField((new DepartmentMeta())->setName('bar_meta')->setIsVisible(true));
        ...
        $expected = [
            ...
            'department.meta.foo_meta',
            'department.meta.bar_meta',
