...
abstract class AbstractRendererTestCase extends KernelTestCase
{
    protected function render(ExportRendererInterface $renderer): Response
    {
        ...
        $department->setNumber('A-0123456789');
        $department->setVatId('DE-9876543210');
        $department->setMetaField((new DepartmentMeta())->setName('department-foo')->setValue('department-bar')->setIsVisible(true));
...
class MetaFieldColumnSubscriber implements EventSubscriberInterface
{
    public static function getSubscribedEvents(): array
    {
        return [
            ...
            DepartmentMetaDisplayEvent::class => ['loadDepartmentField', 200],
    ...
    public function loadDepartmentField(DepartmentMetaDisplayEvent $event): void
    {
        $event->addField($this->prepareEntity(new DepartmentMeta(), 'department-foo'));
    }
