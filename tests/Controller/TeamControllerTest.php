...
class TeamControllerTest extends AbstractControllerBaseTestCase
{
    ...
    public function testCreateAction(): void
    {
        ...
        $this->assertHasDepartmentAndProjectPermissionBoxes($client);
    }

    protected function assertHasDepartmentAndProjectPermissionBoxes(HttpKernelBrowser $client): void
    {
        $content = $client->getResponse()->getContent();
        self::assertStringContainsString('Grant access to departments', $content);
        self::assertStringContainsString('Grant access to projects', $content);
        self::assertEquals(1, $client->getCrawler()->filter('form[name=team_department_form]')->count());
