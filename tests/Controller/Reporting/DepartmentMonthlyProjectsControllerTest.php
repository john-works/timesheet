...
#[Group('integration')]
class DepartmentMonthlyProjectsControllerTest extends AbstractControllerBaseTestCase
{
    public function testReportIsSecure(): void
    {
        $this->assertUrlIsSecured('/reporting/department/monthly_projects/view');
    }

    public function testExportReportIsSecure(): void
    {
        $this->assertUrlIsSecured('/reporting/department/monthly_projects/export');
    }
    ...
    private function prepareReport(): HttpKernelBrowser
    {
        ...
        $departments = new DepartmentFixtures();
        $departments->setIsVisible(true);
        $departments->setAmount(1);
        $departments = $this->importFixture($departments);

        $projects = new ProjectFixtures();
        $projects->setDepartments($departments);
    ...
    public function testReport(): void
    {
        ...
        $this->assertAccessIsGranted($client, '/reporting/department/monthly_projects/view');
    ...
    public function testExport(): void
    {
        ...
        $this->assertAccessIsGranted($client, '/reporting/department/monthly_projects/export');
