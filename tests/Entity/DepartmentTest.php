...
class DepartmentTest extends AbstractEntityTestCase
{
    public function testDefaultValues(): void
    {
        $sut = new Department('foo');
        ...
        self::assertEquals('EUR', Department::DEFAULT_CURRENCY);
    ...
    {
        $this->assertBudget(new Department('foo'));
    }

    public function testSetterAndGetter(): void
    {
        $sut = new Department('foo-bar');
...
zip 12345 looney toon', $sut->getFormattedAddress());
    ...
    public function testMetaFields(): void
    {
        ...
        self::assertInstanceOf(Department::class, $sut->setMetaField($meta));
        ...
        $meta2 = new DepartmentMeta();
        $meta2->setName('foo')->setValue('bar')->setType('test2');
        self::assertInstanceOf(Department::class, $sut->setMetaField($meta2));
        self::assertEquals(1, $sut->getMetaFields()->count());
        ...
        $sut->setMetaField((new DepartmentMeta())->setName('blub')->setIsVisible(true));
        $sut->setMetaField((new DepartmentMeta())->setName('blab')->setIsVisible(true));
    ...
    public function testTeams(): void
    {
        ...
        self::assertEmpty($team->getDepartments());

        $sut->addTeam($team);
        self::assertCount(1, $sut->getTeams());
        self::assertCount(1, $team->getDepartments());
        self::assertSame($team, $sut->getTeams()[0]);
        self::assertSame($sut, $team->getDepartments()[0]);
    ...
    public function testExportAnnotations(): void
    {
        ...
        $columns = $sut->extract(Department::class);
    ...
    {
        $sut = new Department('mydepartment');
        ...
        self::assertEquals('mydepartment', $clone->getName());
    }
}
