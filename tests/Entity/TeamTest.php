...
class TeamTest extends TestCase
{
    public function testDefaultValues(): void
    {
        ...
        self::assertInstanceOf(Collection::class, $sut->getDepartments());
        self::assertEquals(0, $sut->getDepartments()->count());
    ...
    public function testDepartment(): void
    {
        ...
        self::assertEmpty($department->getTeams());

        $sut = new Team('foo');
        self::assertFalse($sut->hasDepartment($department));
        $sut->addDepartment($department);
        self::assertEquals(1, $sut->getDepartments()->count());
        self::assertTrue($sut->hasDepartment($department));
        $actual = $sut->getDepartments()[0];
        self::assertSame($actual, $department);
        self::assertSame($sut, $department->getTeams()[0]);
        $sut->removeDepartment(new Department('foo'));
        self::assertEquals(1, $sut->getDepartments()->count());
        $sut->removeDepartment($department);
        self::assertEquals(0, $sut->getDepartments()->count());
    }
    ...
    public function testClone(): void
    {
        ...
        $team = new Team('foo');
        $team->addDepartment($c);
        $team->addDepartment(new Department('foo'));
        $team->addProject($p);
        ...
        self::assertSame($c, $sut->getDepartments()[0]);
