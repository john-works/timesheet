...
class InvoiceTemplateTest extends TestCase
{
    ...
    public function testSetterAndGetter(): void
    {
        ...
        $department->setVatId('0987654321');
        $department->setCompany('bar');
        $department->setAddressLine1('elmstreet');
        $department->setAddressLine2('2nd floor');
        $department->setPostCode('4711');
        $department->setCity('Over the rainbow');
...
4711 Over the rainbow', $sut->getAddress());
    ...
    public function testThrowsOnMetaFieldWithoutName(): void
    {
        ...
        $sut = new InvoiceTemplate();
        $sut->setMetaField(new DepartmentMeta());
    }
