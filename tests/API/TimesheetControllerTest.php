...
class TimesheetControllerTest extends APIControllerBaseTestCase
{
    ...
    // already filtered within the repository due to the hidden department
    public function testPostActionWithInvisibleProject(): void
    {
        $client = $this->getClientForAuthenticatedUser(User::ROLE_USER);

        $em = $this->getEntityManager();
        $department = new Department('foo-bar-1');
    ...
    public function testPostActionWithNonBillableDepartment(): void
    {
        $client = $this->getClientForAuthenticatedUser(User::ROLE_TEAMLEAD);
    ...
    public function testPostActionWithNonBillableDepartmentExplicit(): void
    {
        $client = $this->getClientForAuthenticatedUser(User::ROLE_TEAMLEAD);
