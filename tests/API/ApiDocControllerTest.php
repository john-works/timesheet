...
class ApiDocControllerTest extends AbstractControllerBaseTestCase
{
    ...
    public function testGetDocs(): void
    {
        ...
        $expectedKeys = ['Actions', 'Activity', 'Default', 'Department', 'Project', 'Tag', 'Team', 'Timesheet', 'User', 'Invoice', 'Export'];
        ...
        $paths = [
            ...
            '/api/actions/department/{id}/{view}/{locale}',
            '/api/activities',
            '/api/activities/{id}',
            ...
            '/api/departments',
            '/api/departments/{id}',
            '/api/departments/{id}/meta',
            '/api/departments/{id}/rates',
            '/api/departments/{id}/rates/{rateId}',
            '/api/export/{id}',
            '/api/invoices',
            '/api/invoices/{id}',
            ...
            '/api/teams/{id}/departments/{departmentId}',
