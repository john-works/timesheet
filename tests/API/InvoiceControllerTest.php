...
class InvoiceControllerTest extends APIControllerBaseTestCase
{
    ...
    public function testGetEntityRespectsDepartmentPermission(): void
    {
        $client = $this->getClientForAuthenticatedUser(User::ROLE_TEAMLEAD);
    ...
    public function testDownloadRespectsDepartmentPermission(): void
    {
        $client = $this->getClientForAuthenticatedUser(User::ROLE_TEAMLEAD);
    ...
    public function testCollectionRespectsDepartmentPermission(): void
    {
        $client = $this->getClientForAuthenticatedUser(User::ROLE_TEAMLEAD);
        ...
        $query = ['departments' => [$department->getId()]];
        $this->assertAccessIsGranted($client, '/api/invoices', 'GET', $query);
