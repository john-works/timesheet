...
class TimesheetRepositoryTest extends AbstractRepositoryTestCase
{
    public function testResultTypeForQueryState(): void
    {
        ...
        self::assertFalse($query->hasQueryHint(TimesheetQueryHint::DEPARTMENT_META_FIELDS));
        ...
        self::assertTrue($query->hasQueryHint(TimesheetQueryHint::DEPARTMENT_META_FIELDS));
