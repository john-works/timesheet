...
#[CoversClass(DepartmentCreateEvent::class)]
class DepartmentCreateEventTest extends AbstractDepartmentEventTestCase
{
    protected function createDepartmentEvent(Department $department): AbstractDepartmentEvent
    {
        return new DepartmentCreateEvent($department);
    }
}
