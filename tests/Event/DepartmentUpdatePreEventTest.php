...
#[CoversClass(DepartmentUpdatePreEvent::class)]
class DepartmentUpdatePreEventTest extends AbstractDepartmentEventTestCase
{
    protected function createDepartmentEvent(Department $department): AbstractDepartmentEvent
    {
        return new DepartmentUpdatePreEvent($department);
    }
}
