...
#[CoversClass(DepartmentUpdatePostEvent::class)]
class DepartmentUpdatePostEventTest extends AbstractDepartmentEventTestCase
{
    protected function createDepartmentEvent(Department $department): AbstractDepartmentEvent
    {
        return new DepartmentUpdatePostEvent($department);
    }
}
