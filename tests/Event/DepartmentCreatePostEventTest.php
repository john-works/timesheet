...
#[CoversClass(DepartmentCreatePostEvent::class)]
class DepartmentCreatePostEventTest extends AbstractDepartmentEventTestCase
{
    protected function createDepartmentEvent(Department $department): AbstractDepartmentEvent
    {
        return new DepartmentCreatePostEvent($department);
    }
}
