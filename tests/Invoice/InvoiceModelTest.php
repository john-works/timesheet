...
class InvoiceModelTest extends TestCase
{
    public function testEmptyObject(): void
    {
        ...
        $sut = (new InvoiceModelFactoryFactory($this))->create()->createModel($formatter, new Department('foo'), new InvoiceTemplate(), new InvoiceQuery());
    ...
    public function testSetter(): void
    {
        ...
        $sut = (new InvoiceModelFactoryFactory($this))->create()->createModel(new DebugFormatter(), $department, $template, $query);
