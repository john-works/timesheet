...
class SystemConfigurationTest extends TestCase
{
    ...
    {
        return [
            (new Configuration())->setName('defaults.department.timezone')->setValue('Russia/Moscov'),
            (new Configuration())->setName('defaults.department.currency')->setValue('RUB'),
    ...
    public function testDefaultWithoutLoader(): void
    {
        ...
        self::assertEquals('Europe/London', $sut->find('defaults.department.timezone'));
        self::assertEquals('GBP', $sut->find('defaults.department.currency'));
    ...
    public function testDefaultWithLoader(): void
    {
        ...
        self::assertEquals('Russia/Moscov', $sut->find('defaults.department.timezone'));
        self::assertEquals('RUB', $sut->find('defaults.department.currency'));
    ...
    {
        $sut = $this->getSut($this->getDefaultSettings(), []);
        self::assertEquals('Europe/London', $sut->getDepartmentDefaultTimezone());
        self::assertEquals('GBP', $sut->getDefaultCurrency());
        self::assertEquals('FR', $sut->getDepartmentDefaultCountry());
    ...
    {
        $sut = $this->getSut($this->getDefaultSettings(), $this->getDefaultLoaderSettings());
        self::assertEquals('Russia/Moscov', $sut->getDepartmentDefaultTimezone());
