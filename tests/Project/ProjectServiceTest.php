...
class ProjectServiceTest extends TestCase
{
    ...
    public function testCreateNewProjectDispatchesEvents(): void
    {
        ...
        $project = $sut->createNewProject($department);

        self::assertSame($department, $project->getDepartment());
    }
    ...
    public function testCreateNewProjectWithoutDepartment(): void
    {
        $sut = $this->getSut();

        $project = $sut->createNewProject();
        self::assertNull($project->getDepartment());
