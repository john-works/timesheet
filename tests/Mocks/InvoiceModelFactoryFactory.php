...
class InvoiceModelFactoryFactory extends AbstractMockFactory
{
    ...
    {
        /** @var DepartmentStatisticService $departmentStatistic */
        $departmentStatistic = $this->getMockBuilder(DepartmentStatisticService::class)->disableOriginalConstructor()->getMock();
        ...
        $modelHydrators = [
            ...
            new InvoiceModelDepartmentHydrator($departmentStatistic),
