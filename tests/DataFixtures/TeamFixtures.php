...
final class TeamFixtures implements TestFixture
{
    ...
    private bool $addDepartment = true;
    /**
     * @var User[]
     */
    ...
    public function setAddDepartment(bool $useDepartment): TeamFixtures
    {
        $this->addDepartment = $useDepartment;
    ...
    public function load(ObjectManager $manager): array
    {
        ...
        $department = $this->getAllDepartments($manager);
        ...
        for ($i = 0; $i < $this->amount; $i++) {
            ...
            if ($this->addDepartment) {
                $team->addDepartment($department[array_rand($department)]);
            }
