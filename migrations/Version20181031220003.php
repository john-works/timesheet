...
final class Version20181031220003 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE kimai2_projects CHANGE department_id department_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        // project table
        $this->addSql('ALTER TABLE kimai2_projects DROP FOREIGN KEY FK_407F12069395C3F3');
        $this->addSql('ALTER TABLE kimai2_projects CHANGE department_id department_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE kimai2_projects ADD CONSTRAINT FK_407F12069395C3F3 FOREIGN KEY (department_id) REFERENCES kimai2_departments (id) ON DELETE CASCADE');
        // timesheet table
