...
final class Version20190706224219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $project->addIndex(['department_id', 'visible', 'name'], 'IDX_407F12069395C3F37AB0E8595E237E06');
        $project->addIndex(['department_id', 'visible', 'id'], 'IDX_407F12069395C3F37AB0E859BF396750');

        $department = $schema->getTable('kimai2_departments');
        $name = $department->getColumn('name');
        if ($name->getLength() !== 150) {
            $name->setLength(150);
        }
        $department->addIndex(['visible'], 'IDX_5A9760447AB0E859');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $department = $schema->getTable('kimai2_departments');
        $department->dropIndex('IDX_5A9760447AB0E859');
        $department->getColumn('name')->setLength(255);
