...
final class Version20200308171950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $invoices->addColumn('department_id', 'integer', ['length' => 11, 'notnull' => true]);
        ...
        $invoices->addForeignKeyConstraint('kimai2_departments', ['department_id'], ['id'], ['onDelete' => 'CASCADE'], 'FK_76C38E379395C3F3');
