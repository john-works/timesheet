...
final class Version20180701120000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE kimai2_projects ADD CONSTRAINT FK_407F12069395C3F3 FOREIGN KEY (department_id) REFERENCES kimai2_departments (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $schema->dropTable('kimai2_departments');
    }
}
