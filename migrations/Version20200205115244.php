...
final class Version20200205115244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        $migrates = [
            ...
            ['kimai2_departments', 'department_id', 'kimai2_departments_rates'],
        ];
        ...
        $schema->getTable('kimai2_departments')->dropColumn('fixed_rate')->dropColumn('hourly_rate');
    ...
    {
        $this->addSql('ALTER TABLE kimai2_departments ADD COLUMN fixed_rate NUMERIC(10, 2) DEFAULT NULL');
        $this->addSql('ALTER TABLE kimai2_departments ADD COLUMN hourly_rate NUMERIC(10, 2) DEFAULT NULL');
