...
final class Version20190706224211 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $departmentMeta = $schema->getTable('kimai2_departments_meta');
        $departmentMeta->modifyColumn('visible', ['notnull' => true, 'default' => false]);
        $departmentMeta->modifyColumn('department_id', ['notnull' => true]);
