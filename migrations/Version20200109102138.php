...
/**
 * Creates comment tables for departments and projects
 *
 * @version 1.7
 */
final class Version20200109102138 extends AbstractMigration
{
    ...
    {
        return 'Creates comment tables for departments and projects';
    }

    public function up(Schema $schema): void
    {
        $departmentComment = $schema->createTable('kimai2_departments_comments');
        $departmentComment->addColumn('id', 'integer', ['autoincrement' => true, 'notnull' => true]);
        $departmentComment->addColumn('department_id', 'integer', ['notnull' => true]);
        $departmentComment->addColumn('message', 'text', ['notnull' => true]);
        $departmentComment->addColumn('created_by_id', 'integer', ['notnull' => true]);
        $departmentComment->addColumn('created_at', 'datetime', ['notnull' => true]);
        $departmentComment->addColumn('pinned', 'boolean', ['notnull' => true, 'default' => false]);
        $departmentComment->setPrimaryKey(['id']);
        $departmentComment->addIndex(['department_id'], 'IDX_A5B142D99395C3F3');
        $departmentComment->addForeignKeyConstraint('kimai2_departments', ['department_id'], ['id'], ['onDelete' => 'CASCADE'], 'FK_A5B142D99395C3F3');
        $departmentComment->addForeignKeyConstraint('kimai2_users', ['created_by_id'], ['id'], ['onDelete' => 'CASCADE'], 'FK_A5B142D9B03A8386');
    ...
    public function down(Schema $schema): void
    {
        ...
        $schema->dropTable('kimai2_departments_comments');
    }
}
