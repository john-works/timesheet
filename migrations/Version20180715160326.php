...
final class Version20180715160326 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE kimai2_users SET roles = \'a:1:{i:0;s:13:"ROLE_DEPARTMENT";}\' WHERE roles LIKE \'%ROLE_DEPARTMENT%\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE kimai2_users SET roles = \'["ROLE_DEPARTMENT"]\' WHERE roles LIKE \'%ROLE_DEPARTMENT%\'');
