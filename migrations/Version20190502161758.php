...
/**
 * Creates the color columns on: department, project, activity.
 *
 * @version 1.0
 */
final class Version20190502161758 extends AbstractMigration
{
    ...
    {
        return 'Creates the color columns on: department, project, activity';
    }

    public function up(Schema $schema): void
    {
        $departments = $schema->getTable('kimai2_departments');
        $departments->addColumn('color', 'string', ['length' => 7, 'notnull' => false, 'default' => null]);
