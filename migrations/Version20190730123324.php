...
final class Version20190730123324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $departmentTeams = $schema->createTable('kimai2_departments_teams');
        $departmentTeams->addColumn('department_id', 'integer', ['length' => 11, 'notnull' => true]);
        $departmentTeams->addColumn('team_id', 'integer', ['length' => 11, 'notnull' => true]);
        $departmentTeams->addForeignKeyConstraint('kimai2_departments', ['department_id'], ['id'], ['onDelete' => 'CASCADE'], 'FK_50BD83889395C3F3');
        $departmentTeams->addForeignKeyConstraint('kimai2_teams', ['team_id'], ['id'], ['onDelete' => 'CASCADE'], 'FK_50BD8388296CD8AE');
        $departmentTeams->setPrimaryKey(['department_id', 'team_id']);
    ...
    public function down(Schema $schema): void
    {
        ...
        $schema->dropTable('kimai2_departments_teams');
