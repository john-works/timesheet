...
final class Version20190617100845 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $departmentMeta = $schema->createTable('kimai2_departments_meta');
        $departmentMeta->addColumn('id', 'integer', ['autoincrement' => true, 'notnull' => true]);
        $departmentMeta->addColumn('department_id', 'integer', ['notnull' => true]);
        $departmentMeta->addColumn('name', 'string', ['notnull' => true, 'length' => 50]);
        $departmentMeta->addColumn('value', 'string', ['notnull' => false, 'length' => 255]);
        $departmentMeta->addColumn('visible', 'boolean', ['notnull' => false, 'default' => false]);
        $departmentMeta->setPrimaryKey(['id']);
        $departmentMeta->addIndex(['department_id'], 'IDX_A48A760F9395C3F3');
        $departmentMeta->addUniqueIndex(['department_id', 'name'], 'UNIQ_A48A760F9395C3F35E237E06');
        $departmentMeta->addForeignKeyConstraint('kimai2_departments', ['department_id'], ['id'], ['onDelete' => 'CASCADE'], 'FK_A48A760F9395C3F3');
    ...
    public function down(Schema $schema): void
    {
        ...
        $schema->dropTable('kimai2_departments_meta');
