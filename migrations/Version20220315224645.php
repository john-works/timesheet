...
final class Version20220315224645 extends AbstractMigration
{
    ...
    {
        return 'Adds billable fields to Department, Project and Activity';
    }

    public function up(Schema $schema): void
    {
        $departments = $schema->getTable('kimai2_departments');
        $departments->addColumn('billable', 'boolean', ['notnull' => true, 'default' => true]);
    ...
    {
        $departments = $schema->getTable('kimai2_departments');
        $departments->dropColumn('billable');
