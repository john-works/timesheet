...
export default class KimaiCalendar {
     ...
     * @return {{activity, color: *, start, description, project, end, id, title: *, textColor: *, department, tags: ([number,number,[],string,string]|*)}}
     * @private
     */
    convertSourceForCalendar(apiItem) {
        ...
        if (color === null || color === defaultColor) {
            ...
            if (color === null || color === defaultColor) {
                color = apiItem.project.department.color;
            }
        }
        if (color === null) {
            color = defaultColor;
        ...
        title = title.replace('{department}', apiItem.project.department.name);
        ...
        return {
            ...
            department: apiItem.project.department.name,
            tags: apiItem.tags,
            color: color,
    ...
    renderEventPopoverContent(event) {
        ...
        return escaper.sanitize(`
            <div class="calendar-entry">
                <ul>
                    <li>` + this.options['translations']['department'] + `: ` + escaper.escapeForHtml(eventObj.department) + `</li>
