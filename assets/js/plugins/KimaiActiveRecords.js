...
export default class KimaiActiveRecords extends KimaiPlugin {
    ...
    init()
    {
        ...
        document.addEventListener('kimai.departmentUpdate', handleUpdate);
        document.addEventListener('kimai.departmentDelete', handleUpdate);
    ...
    _replaceInNode(node, timesheet)
    {
        ...
        for (let link of allReplacer) {
            ...
            } else if (replacerName === 'department') {
                link.innerText = timesheet.project.department.name;
