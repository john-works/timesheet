...
class InvoiceTemplate implements EntityWithMetaFields
{
    ...
    /**
     * Department for this invoice template
     */
    ...
    {
        return $this->department?->getFormattedAddress() ?? $this->address;
    }
    ...
    {
        return $this->department?->getCompany() ?? $this->department?->getName() ?? $this->company;
    }
    ...
    {
        return $this->department?->getVatId() ?? $this->vatId;
    }
