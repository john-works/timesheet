...
#[ORM\Table(name: 'kimai2_departments')]
...
class Department implements EntityWithMetaFields, EntityWithBudget, CreatedAt
{
    ...
    #[Assert\Length(max: 50)]
    #[Serializer\Expose]
    #[Serializer\Groups(['Department_Entity'])]
    ...
    /**
     * Meta fields registered with the department
     *
     * @var Collection<DepartmentMeta>
     */
    #[ORM\OneToMany(mappedBy: 'department', targetEntity: DepartmentMeta::class, cascade: ['persist'])]
    #[Serializer\Expose]
    #[Serializer\Groups(['Default'])]
    #[Serializer\Type(name: 'array<App\Entity\DepartmentMeta>')]
    #[Serializer\SerializedName('metaFields')]
    #[Serializer\Accessor(getter: 'getVisibleMetaFields')]
    private Collection $meta;
    /**
     * Teams with access to the department
     *
     * @var Collection<Team>
     */
    #[ORM\JoinTable(name: 'kimai2_departments_teams')]
    ...
    #[ORM\ManyToMany(targetEntity: Team::class, inversedBy: 'departments', cascade: ['persist'])]
    #[Serializer\Expose]
    #[Serializer\Groups(['Department'])]
    #[OA\Property(type: 'array', items: new OA\Items(ref: '#/components/schemas/Team'))]
    private Collection $teams;
    /**
     * Default invoice template for this department
     */
