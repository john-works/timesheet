...
#[Exporter\Order(['id', 'createdAt', 'invoiceNumber', 'status', 'department', 'subtotal', 'total', 'tax', 'currency', 'vat', 'dueDays', 'dueDate', 'paymentDate', 'user', 'invoiceFilename', 'departmentNumber', 'comment'])]
#[Exporter\Expose(name: 'department', label: 'department', exp: 'object.getDepartment() === null ? null : object.getDepartment().getName()')]
#[Exporter\Expose(name: 'departmentNumber', label: 'number', exp: 'object.getDepartment() === null ? null : object.getDepartment().getNumber()')]
