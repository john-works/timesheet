...
class Team
{
    ...
    /**
     * Departments assigned to the team
     *
     * @var Collection<Department>
     */
    #[ORM\ManyToMany(targetEntity: Department::class, mappedBy: 'teams', cascade: ['persist'], fetch: 'EXTRA_LAZY')]
    #[Serializer\Expose]
    #[Serializer\Groups(['Team_Entity'])]
    #[OA\Property(type: 'array', items: new OA\Items(ref: '#/components/schemas/Department'))]
