...
#[ORM\Index(columns: ['department_id', 'visible', 'name'])]
#[ORM\Index(columns: ['department_id', 'visible', 'id'])]
#[ORM\Entity(repositoryClass: ProjectRepository::class)]
#[ORM\ChangeTrackingPolicy('DEFERRED_EXPLICIT')]
#[Serializer\ExclusionPolicy('all')]
#[Serializer\VirtualProperty('DepartmentName', exp: 'object.getDepartment() === null ? null : object.getDepartment().getName()', options: [new Serializer\SerializedName('parentTitle'), new Serializer\Type(name: 'string'), new Serializer\Groups(['Project'])])]
#[Serializer\VirtualProperty('DepartmentAsId', exp: 'object.getDepartment() === null ? null : object.getDepartment().getId()', options: [new Serializer\SerializedName('department'), new Serializer\Type(name: 'integer'), new Serializer\Groups(['Project', 'Team', 'Not_Expanded'])])]
#[Exporter\Order(['id', 'name', 'department', 'orderNumber', 'orderDate', 'start', 'end', 'budget', 'timeBudget', 'budgetType', 'color', 'visible', 'comment', 'billable', 'number'])]
#[Exporter\Expose(name: 'department', label: 'department', exp: 'object.getDepartment() === null ? null : object.getDepartment().getName()')]
#[Constraints\Project]
class Project implements EntityWithMetaFields, EntityWithBudget, CreatedAt
{
    ...
    public function isVisibleAtDate(\DateTime $dateTime): bool
    {
        ...
        if ($this->getDepartment() !== null && !$this->getDepartment()->isVisible()) {
            return false;
        }
