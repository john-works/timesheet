...
final class RolePermissionManager
{
    ...
    public function checkTeamAccessDepartment(Department $department, User $user): bool
    {
        return $this->checkTeamAccess($department->getTeams(), $user);
    }

    public function checkTeamAccessProject(Project $project, User $user): bool
    {
        if ($project->getDepartment() !== null && !$this->checkTeamAccessDepartment($project->getDepartment(), $user)) {
            return false;
        }
