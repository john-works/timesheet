...
final class PermissionController extends AbstractController
{
    ...
    public function permissions(EventDispatcherInterface $dispatcher, CsrfTokenManagerInterface $csrfTokenManager, RoleService $roleService, UserRepository $userRepository): Response
    {
        ...
        $permissionOrder = [
            ...
            new PermissionSection('Department (Admin)', '_department'),
            new PermissionSection('Department (Team member)', '_team_department'),
            new PermissionSection('Department (Teamlead)', '_teamlead_department'),
