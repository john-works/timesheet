...
final class MenuSubscriber implements EventSubscriberInterface
{
    ...
    public function onMainMenuConfigure(ConfigureMainMenuEvent $event): void
    {
        ...
        if ($auth->isGranted('view_department') || $auth->isGranted('view_teamlead_department') || $auth->isGranted('view_team_department')) {
            $departments = new MenuItemModel('departments', 'departments', 'admin_department', [], 'department');
            $departments->setChildRoutes(['admin_department_create', 'admin_department_permissions', 'department_details', 'admin_department_edit', 'admin_department_delete']);
