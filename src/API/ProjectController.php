...
final class ProjectController extends BaseApiController
{
    ...
    #[Rest\QueryParam(name: 'department', requirements: '\d+', strict: true, nullable: true, description: 'Department ID to filter projects')]
    ...
    #[Rest\QueryParam(name: 'orderBy', requirements: 'id|name|department', strict: true, nullable: true, description: 'The field by which results will be ordered. Allowed values: id, name, department (default: name)')]
    #[Rest\QueryParam(name: 'term', description: 'Free search term', nullable: true)]
    public function cgetAction(ParamFetcherInterface $paramFetcher, DepartmentRepository $departmentRepository): Response
    {
        /** @var User $user */
        $user = $this->getUser();
