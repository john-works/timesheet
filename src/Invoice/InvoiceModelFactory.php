...
final class InvoiceModelFactory
{
    ...
    public function createModel(InvoiceFormatter $formatter, Department $department, InvoiceTemplate $template, InvoiceQuery $query): InvoiceModel
    {
        $model = new InvoiceModel($formatter, $department, $template, $this->rateCalculatorMode);
