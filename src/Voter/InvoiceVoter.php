...
final class InvoiceVoter extends Voter
{
    ...
    protected function voteOnAttribute(string $attribute, mixed $subject, TokenInterface $token): bool
    {
        ...
        // check if the user is allowed to see the invoice department
        if (!$this->rolePermissionManager->checkTeamAccessDepartment($subject->getDepartment(), $user)) {
            return false;
        }
        ...
        // there is no edit_invoice, so we only check if the user can create an invoice for the department
