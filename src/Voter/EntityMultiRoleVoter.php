...
/**
 * @extends Voter<string, Activity|Project|Department|string>
 */
final class EntityMultiRoleVoter extends Voter
{
    /**
     * support rules based on the given activity/project/department
     */
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        if ($subject instanceof Activity || $subject instanceof Project || $subject instanceof Department) {
            return true;
        }
    ...
    protected function voteOnAttribute(string $attribute, mixed $subject, TokenInterface $token): bool
    {
        ...
        if (\is_string($subject) && \in_array($subject, self::ALLOWED_SUBJECTS, true)) {
            ...
            $suffix = 'project';
        } elseif ($subject instanceof Department) {
            $suffix = 'department';
        }
