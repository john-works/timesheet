...
final class ResetTestCommand extends AbstractResetCommand
{
    ...
    protected function loadData(InputInterface $input, OutputInterface $output): void
    {
        ...
        $department->setComment('Test comment');
        $department->setContact('Test');
        $department->setAddress('Test');
        $department->setCompany('Test');
        $department->setCountry('DE');
        $department->setCurrency('EUR');
        $department->setPhone('111');
        $department->setFax('222');
        $department->setMobile('333');
        $department->setEmail('test@example.com');
        $department->setTimeBudget(100000);
        ...
        $user1->setRoles(['ROLE_DEPARTMENT']);
        $user1->setUserIdentifier('clara_department');
        $user1->setEmail('clara_department@example.com');
        $token1 = new AccessToken($user1, UserFixtures::DEFAULT_API_TOKEN . '_department');
