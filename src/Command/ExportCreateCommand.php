...
final class ExportCreateCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('department', null, InputOption::VALUE_REQUIRED | InputOption::VALUE_IS_ARRAY, 'Department IDs to filter', null)
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $departmentIDs = $this->optionToIntArray($input, 'department');
        $departments = [];
        if (\count($departmentIDs) > 0) {
            $departments = $this->departmentRepository->findByIds($departmentIDs);
        }
        ...
        $query->setDepartments($departments);
