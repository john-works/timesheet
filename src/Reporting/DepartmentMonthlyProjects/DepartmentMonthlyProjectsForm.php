...
/**
 * @extends AbstractType<DepartmentMonthlyProjects>
 */
final class DepartmentMonthlyProjectsForm extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => DepartmentMonthlyProjects::class,
