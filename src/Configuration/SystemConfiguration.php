...
final class SystemConfiguration
{
    ...
    public function getDepartmentDefaultTimezone(): ?string
    {
        return $this->find('defaults.department.timezone');
    }

    public function getDepartmentDefaultCountry(): string
    {
        return $this->find('defaults.department.country');
    }
    ...
    {
        return $this->getString('defaults.department.currency', 'EUR');
    }

    /**
     * @deprecated use getDefaultCurrency() instead
     */
    public function getDepartmentDefaultCurrency(): string
    {
