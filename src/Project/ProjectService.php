...
final class ProjectService
{
    ...
    public function createNewProject(?Department $department = null): Project
    {
        $project = new Project();
    ...
    public function findProjectByName(string $name, ?Department $department): ?Project
    {
        if ($department !== null) {
            return $this->repository->findOneBy(['name' => $name, 'department' => $department->getId()]);
        }
