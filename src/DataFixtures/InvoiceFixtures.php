...
final class InvoiceFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        /** @var non-empty-array<Department> $departments */
        $departments = $manager->getRepository(Department::class)->findBy(['visible' => true]);
        ...
        foreach ($this->getInvoiceConfigs($faker) as $invoiceConfig) {
            ...
            $template->setDepartment($departments[array_rand($departments)]);
