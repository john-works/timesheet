...
class HtmlRenderer implements ExportRendererInterface
{
    ...
    public function render(array $exportItems, TimesheetQuery $query): Response
    {
        ...
        $departmentMetaFields = $this->findMetaColumns(new DepartmentMetaDisplayEvent($query->copyTo(new DepartmentQuery()), DepartmentMetaDisplayEvent::EXPORT));
        ...
        $content = $this->twig->render($this->getTemplate(), array_merge([
            ...
            'departmentMetaFields' => $departmentMetaFields,
