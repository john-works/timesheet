...
{
    public function __construct(private TimesheetRepository $timesheet, private DepartmentRepository $departments)
    {
    }
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $currency = null;
        $entry = null;
        $departmentCount = $this->departments->countDepartment(true);
        ...
        $builder->addEventListener(
            ...
            function (FormEvent $event) use ($project, $department): void {
                $data = $event->getData();
                $department = isset($data['department']) && !empty($data['department']) ? $data['department'] : null;
