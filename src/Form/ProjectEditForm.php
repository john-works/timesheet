...
class ProjectEditForm extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        if (isset($options['data'])) {
            ...
            if (null !== $entry->getDepartment()) {
                ...
                if (!$department->isVisible()) {
                    ...
                    $departmentOptions['pre_select_department'] = true;
                }
            }
        }
        ...
        $builder
            ...
            ->add('department', DepartmentType::class, array_merge([
                'placeholder' => ($isNew && null === $department) ? '' : false,
