...
final class ProjectType extends AbstractType
{
    public function __construct(
        ...
        private readonly DepartmentHelper $departmentHelper
    )
    {
    }
    ...
    {
        if (null !== ($department = $project->getDepartment())) {
            return ['data-department' => $department->getId(), 'data-currency' => $department->getCurrency()];
        }
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            ...
            'group_by' => function (Project $project, $key, $index) {
                ...
                return $this->departmentHelper->getChoiceLabel($project->getDepartment());
            },
            ...
            'ignore_date' => false,
            'join_department' => false,
            // @var Project|null
            'ignore_project' => null,
            // @var Department|Department[]|int|int[]|null
            'departments' => null,
        ...
        $resolver->setDefault('query_builder', function (Options $options) {
            return function (ProjectRepository $repo) use ($options) {
                $query = new ProjectFormTypeQuery($options['projects'], $options['departments']);
                ...
                if (true === $options['join_department']) {
