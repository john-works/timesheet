...
final class ExportColumnsType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        foreach ($this->findMetaColumns(new DepartmentMetaDisplayEvent(new DepartmentQuery(), DepartmentMetaDisplayEvent::EXPORT)) as $metaField) {
            if ($metaField->getName() !== null) {
                $columns['department'][$metaField->getLabel()] = 'department.meta.' . $metaField->getName();
            }
        }
