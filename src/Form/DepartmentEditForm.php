 ...
 */
class DepartmentEditForm extends AbstractType
{
    use EntityFormTrait;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        if (isset($options['data'])) {
            ...
            $isNew = $department->getId() === null;
            $options['currency'] = $department->getCurrency();
            $hasAddress = $department->getAddress() !== null && $department->getAddress() !== '';
        }
        ...
        $builder
            ...
            ->add('invoiceTemplate', InvoiceTemplateType::class, [
                'help' => 'help.invoiceTemplate_department',
                'required' => false,
            ])
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            ...
            'csrf_token_id' => 'admin_department_edit',
            'currency' => Department::DEFAULT_CURRENCY,
            'include_budget' => false,
            'include_time' => false,
            'attr' => [
                'data-form-event' => 'kimai.departmentUpdate'
            ],
        ]);
    }
}
